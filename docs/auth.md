...
```json
{"oci": {"type": "oci_signing_v1", "tenancy_ocid_env_var": "OCI_TENANCY_OCID", "user_ocid_env_var": "OCI_USER_OCID", "fingerprint_env_var": "OCI_FINGERPRINT", "private_key_path_env_var": "OCI_PRIVATE_KEY_PATH"}}
```
