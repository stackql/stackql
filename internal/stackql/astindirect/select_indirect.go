...
func (v *parserSelectionIndirect) GetOptionalParameters() map[string]formulation.Addressable {
	return nil
}

func (v *parserSelectionIndirect) GetRequiredParameters() map[string]formulation.Addressable {
	return nil
}
