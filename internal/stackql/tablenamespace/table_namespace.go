...
var (
	_ Configurator = &regexTableNamespaceConfigurator{}
)
...
func (stc *regexTableNamespaceConfigurator) Read(
	tableString string,
	requestEncoding string,
	requestEncodingColName string,
	nonControlColumnNames []string,
) (*sql.Rows, error) {
...
func (stc *regexTableNamespaceConfigurator) Match(
	tableString string,
	requestEncoding string,
	lastModifiedColName string,
	requestEncodingColName string,
) (internaldto.TxnControlCounters, bool) {
	isAllowed := stc.templateNamespaceConfigurator.IsAllowed(tableString)
	if !isAllowed {
		return nil, false
	}
	...
	oldestUpdate, tcc := stc.sqlSystem.TableOldestUpdateUTC(
		actualTableName,
		requestEncoding,
		lastModifiedColName, requestEncodingColName)
...
func (stc *regexTableNamespaceConfigurator) WithSQLSystem(sqlSystem sql_system.SQLSystem) (Configurator, error) {
