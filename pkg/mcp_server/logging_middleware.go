...
// Unwrap lets http.ResponseController reach the underlying Flusher, which
// the SDK relies on to push SSE events (protocol 2026-07-28 discover/tool
// responses otherwise sit unflushed until the handler returns).
