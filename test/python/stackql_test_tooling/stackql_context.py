...
def get_variables(
  ...
  TRIPPIN_PEOPLE_SELECT_PROJECTION_PARAMETER_PUSHED_AND_RESPONSE_FILTERED_EXPECTED = get_output_from_local_file(os.path.join('test', 'assets', 'expected', 'trippin', 'people', 'select-people-projection-parameter-pushed-and-response-filtered.txt'))
  TRIPPIN_PEOPLE_SELECT_STAR_PARAMETER_PUSHED_AND_RESPONSE_FILTERED_EXPECTED = get_output_from_local_file(os.path.join('test', 'assets', 'expected', 'trippin', 'people', 'select-people-star-parameter-pushed-and-response-filtered.txt'))
  ...
  rv = {
    ...
    'TRIPPIN_PEOPLE_SELECT_PROJECTION_PARAMETER_PUSHED_AND_RESPONSE_FILTERED_EXPECTED': TRIPPIN_PEOPLE_SELECT_PROJECTION_PARAMETER_PUSHED_AND_RESPONSE_FILTERED_EXPECTED,
    'TRIPPIN_PEOPLE_SELECT_STAR_PARAMETER_PUSHED_AND_RESPONSE_FILTERED_EXPECTED': TRIPPIN_PEOPLE_SELECT_STAR_PARAMETER_PUSHED_AND_RESPONSE_FILTERED_EXPECTED,
